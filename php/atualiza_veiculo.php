...
{
    $idveiculo=$registro;
    $cmd= "INSERT INTO veiculo(idpessoa,chip_veiculo,placa_veiculo,marca,modelo_veiculo,ano_veiculo,cor_veiculo,ano_modelo_veiculo,registro_veiculo,qtdeixos)VALUES("
            .$_REQUEST["idpessoa"].",'"
            .$novochip."','"
            .$placa."','"
            .$marca."','"
    ...
    else 
    {
        ...
        {
            $mensagem="Veículo não criado: ".mysql_error();
        }
        $response["success"] = 0;
