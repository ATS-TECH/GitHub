  ...
  <head>
    ...
    function drawChart() {
       ...
       <?php
        ...
        $queryrs = "SELECT distinct marca, modelo, medida, count(*) contador from pneu "
                . " where numero_chip_veiculo in ('".$chip."') group by marca, modelo, medida";
        $conta=0;
        $salva=$queryrs;
        ...
        while($rsan=mysql_fetch_array($resultado))
        {
                ...
                $modelo = $rsan["medida"]."/".$rsan["marca"]."/".$rsan["modelo"];
                echo "data.addRows(1);\n";
        ...
        var options = {
          ...
          title: '',
          is3D: true ,chartArea: {width: '100%',height:'100%'},
...
<h4 class="text-center">Pneus do veículo</h4>
