...
(function(a, h) {
    ...
    function b(a, c) {
        ...
        c.match(/IEMobile/i) && (a.each(a.os, function(c) {
            a.os[c] = !1
    ...
    var f = h.document, e = {}, c = "object" === typeof MSApp;
    a.extend(a.fn, {vendorCss: function(c, d, b) {
            ...
            if (!(0 === this.length || void 0 == a))
                return h.getComputedStyle(this[0], "")[a]
        },
    ...
    a.getCssMatrix = function(c) {
        ...
        if (void 0 === c)
            return d ? new d : {a: 0, b: 0, c: 0, d: 0, e: 0, f: 0};
    ...
    a.create = function(d, b) {
        ...
        if (b || "<" !== d[0]) {
            ...
            e = f.createElement("div"), c ? MSApp.execUnsafeLocalFunction(function() {
                e.innerHTML = d.trim()
            }) : e.innerHTML = d, g(e.childNodes, k);
        return k
    };
...
(function(a) {
    var h = window.location.pathname + window.location.search, g = function() {
        function c() {
            if (d.useOSThemes) {
        ...
        if ("complete" === document.readyState || "loaded" === document.readyState)
            if (b(), d.init)
                ...
                a(window).one("afui:init", function() {
                    d.autoBoot()
                });
        else
    ...
    g.prototype =
            {init: !1, showLoading: !0, loadingText: "Loading Content", remotePages: {}, history: [], views: {}, _readyFunc: null, doingTransition: !1, ajaxUrl: "", transitionType: "slide", firstPanel: "", hasLaunched: !1, isLaunching: !1, launchCompleted: !1, activeDiv: "", customClickHandler: "", useOSThemes: !0, overlayStatusbar: !1, useAutoPressed: !0, useInternalRouting: !0, autoBoot: function() {
                    this.hasLaunched = !0;
                    this.autoLaunch && this.launch()
                }, blockPageBounce: function(c) {
                    a.os.ios && (!1 === c ? (window.removeEventListener("touchmove", this.handlePageBounce,
                            !1), window.removeEventListener("touchstart", this.handlePageBounce, !1)) : (window.addEventListener("touchmove", this.handlePageBounce, !1), window.addEventListener("touchstart", this.handlePageBounce, !1)))
                }, handlePageBounce: function(c) {
                    if ("touchstart" === c.type)
                        this._startTouchY = c.touches[0].screenY;
                    else {
                        var d = a(c.target).closest(".panel");
                        if (0 === d.length)
                            return c.preventDefault();
                        var d = d.get(0), b = d.scrollHeight > d.clientHeight, f = "touch" === a(d).computedStyle("-webkit-overflow-scrolling"), e = "hidden" !== a(d).computedStyle("overflowY"),
                    ...
                    a(document).on("click", ".button-grouped.tabbed", function(c) {
                        var d = a(c.target);
                ...
                disableTabBar: function() {
                ...
                }, manageHistory: !0, loadDefaultHash: !0, actionsheet: function(c) {
                    ...
                    a.unblockUI()
                }, autoLaunch: !0, ready: function(c) {
                    if (this.launchCompleted)
                        c();
                    else
                        a(document).one("afui:ready", function() {
                            c()
                        })
                }, goBack: function(c) {
                    var d =
                    ...
                    if (0 !== d.length && this.views[d.prop("id")]) {
                        ...
                        if (0 !== b.length && (c = b.pop(), 0 !== c.length))
                            if (0 < b.length) {
                                if ((b = b[b.length - 1].target) && c.target !== b)
                                    this.runTransition(c.transition, c.target, b, !0), this.loadContentData(b, d, !0), this.updateHash(b.id)
                            } else
                                try {
                    ...
                    try {
                        this.manageHistory && (window.history.pushState(d, d, h + "#" + d + f), a(window).trigger("hashchange", null, {newUrl: h + "#" + d + f, oldUrl: h + c}))
                    } catch (e) {
                    }
                }, updateHash: function(c) {
                    if (this.manageHistory) {
                        c = -1 === c.indexOf("#") ? "#" + c : c;
                        var d = window.location.hash, b = this.getPanelId(c).substring(1);
                        try {
                            window.history.replaceState(b, b, h + c), a(window).trigger("hashchange", null, {newUrl: h + c, oldUrl: h + d})
                        } catch (f) {
                        }
                    }
                    ...
                    var k = c, g = k.indexOf("#"), h = k.indexOf("/");
                    -1 !== h && -1 !== g && h > g && (k = k.substr(0, h));
                    k = k.replace("#", "");
                    if (k = a.query("#" + k).get(0))
                        if (k === this.activeDiv && !b)
                            this.doingTransition = !1;
                        else {
                            this.transitionType = f;
                            var g = this.findViewTarget(k), h = this.findPreviousPanel(k, g), n = (e = e ? this.findViewTarget(e) : this.findViewTarget(this.activeDiv)) && e.get(0) !== g.get(0) && e.closest(".splitview").get(0) === g.closest(".splitview").get(0) && 0 !== e.closest(".splitview").length;
                            n && (d = !1);
                        ...
                        a(document).trigger("missingpanel", null, {missingTarget: c}), this.doingTransition = !1
                    ...
                    var e = this.views[a.prop("id")].length, f = a.children("header");
                ...
                loadAjax: function(c, b, f, g, h) {
                    var k = this, r = e(c), q = a(".panel[data-crc='" + r + "']"), n = h.getAttribute("data-refresh");
                    if (0 < q.length)
                        if (n)
                            k.showLoading && k.showMask("Loading Content"), a.ajax(c).then(function(a) {
                                q.html(a);
                    ...
                    c || (c = "slide");
                    -1 !== c.indexOf(":back") && (c = c.replace(":back", ""), f = !0);
                    var k = this, h = f ? b : e;
                    b = f ? e : b;
                    e = !1;
                    -1 !== c.indexOf("-reveal") && (c = c.replace("-reveal", ""), e = !0);
                    a(h).css("zIndex", "10");
                    a(b).css("zIndex", "1");
                    a(g).css("zIndex", "1").addClass("active");
                    var q = a(b).animation().remove(c + "-in");
                    !e && q ? (f && q.reverse(), q.end(function() {
                    ...
                    if (!1 === this.hasLaunched || this.launchCompleted)
                        this.hasLaunched = !0;
                    else {
                        if (this.isLaunching)
                            return!0;
                        ...
                        var c = this, d = a.create("div", {id: "afui_mask",
                            className: "ui-loader", html: "<span class='ui-icon ui-icon-loading spin'></span><h1>Loading Content</h1>"}).css({"z-index": 2E4, display: "none"});
                        document.body.appendChild(d.get(0));
                        d = a(".view[data-default='true']");
                        if (0 === d.length && (d = a(".view").eq(0), 0 === d.length))
                            throw"You need to create a view";
                        d.addClass("active");
                        this.views[d.prop("id")] = [];
                        var e = window.location.hash, g = 0 === d.find(".panel[data-selected='true']").length ? d.find(".panel").eq(0) : d.find(".panel[data-selected='true']");
                        g.addClass("active");
                        ...
                        a(document).on("click", function(d) {
                            for (var e = b.length, f = a(d.target), g = 0; g < e; g++) {
                                var h = b[g], m = f.closest(h.sel);
                                0 < m.length && h.cb.call(c, m.get(0), d)
                            }
                        });
                        a(document).on("click", ".backButton, [data-back]", function() {
                            c.useInternalRouting && c.goBack(c)
                        });
                        d = a("[data-include]");
                        if (0 === d.length)
                            this.launchCompleted = !0, a(document).trigger("afui:ready");
                        else {
                            var h = [];
                            d.each(function() {
                                var c = this.getAttribute("data-include"), b = a(this);
                                h.push(a.get(c, function(a) {
                                    b.append(a)
                                }))
                            });
                        ...
                        a(document).on("click",
                                "footer a:not(.button)", function(c) {
                                    c = a(c.target);
    ...
    var f = function(c, b) {
        b = b || c.currentTarget;
        if (b !== document) {
            if (!1 !== ("function" === typeof a.afui.customClickHandler ? a.afui.customClickHandler : !1) && a.afui.customClickHandler(b.getAttribute("href"), c))
                return c.preventDefault();
            if ("a" !== b.tagName.toLowerCase() && b.parentNode)
                return f(c,
                        b.parentNode);
            if ("undefined" !== b.tagName && "a" === b.tagName.toLowerCase() && !(-1 !== b.href.toLowerCase().indexOf("javascript:") || b.getAttribute("data-ignore"))) {
                var e = b.href, g = location.protocol + "//" + location.hostname + ":" + location.port + location.pathname;
                0 === e.indexOf(g) && (e = e.substring(g.length));
                if ("#" === e || e.indexOf("#") === e.length - 1 || 0 === e.length && 0 === b.hash.length)
                    return c.preventDefault();
                g = /^((http|https|file):\/\/)/;
                -1 !== b.href.indexOf(":") && g.test(b.href) && c.preventDefault();
                g = b.getAttribute("data-transition");
                !g && 0 < a(b).closest("footer").length && (g = "none");
                if (g && -1 !== g.indexOf(":dismiss"))
                    return a.afui.dismissView(b, g);
...
(function(a) {
    ...
    var h = function(g, b) {
        if (this.el = "string" === typeof g || g instanceof String ? document.getElementById(g) : g) {
            ...
            if ("string" === typeof b)
                e = a("<div id='af_actionsheet'><div style='width:100%'>" + b + "<a href='javascript:;' class='cancel'>Cancel</a></div></div>");
            else if ("object" ===
                    typeof b) {
            ...
            a("#af_action_mask").bind("touchstart touchmove touchend click", function(a) {
                a.preventDefault();
                a.stopPropagation()
            })
        } else
            window.alert("Could not find element for actionsheet " +
                    g)
    };
    h.prototype = {activeSheet: null, sheetClickHandler: function() {
            this.hideSheet();
            return!1
        }, hideSheet: function() {
            ...
            var g = this.activeSheet, b = this.el;
            setTimeout(function() {
...
(function(a) {
    a.afui.registerDataDirective("[data-grower]", function(h, g) {
        var b = a(h).closest("[data-grower]"), f = b.offset(), e = b.closest(".view"), c = g.target.hash || b.attr("data-grower");
        e.css("zIndex", "1");
        var d = a(c).closest(".view"), m = b.width() / window.innerWidth, l = b.height() / window.innerHeight, p = {left: f.left, top: f.top, x: m, y: l};
    ...
    a(document).ready(function() {
        ...
        a(document.body).bind("touchstart", function(h) {
            ...
            if (!m && (5 < Math.abs(b.x2 -
                ...
                var f = 5 < Math.abs(b.x2 - b.x1), g = 5 < Math.abs(b.y2 - b.y1);
                m = !0;
                b.el.trigger("swipeStart", [e]);
                b.el.trigger("swipeStart" + h(b.x1, b.x2, b.y1, b.y2), [b, e]);
                var l = b.el.closest(".swipe, .swipe-reveal, .swipe-x, .swipe-y"), n = b.el.closest(".x-scroll, .y-scroll, .scroll");
            ...
            clearTimeout(c)
                ...
                function(c) {
                    ...
                    if (b.el)
                        if (a.afui.useAutoPressed && !b.el.attr("data-ignore-pressed") && b.el.removeClass("pressed"), b.isDoubleTap)
                            b.el.trigger("doubleTap"), b = {};
                        else if ((0 < b.x2 || 0 < b.y2) && (30 < Math.abs(b.x1 - b.x2) || 30 < Math.abs(b.y1 - b.y2))) {
                            b.el.trigger("swipe");
                            c = h(b.x1, b.x2, b.y1, b.y2);
                            var e = ".x-scroll", d = ".swipe-x";
                            if ("up" === c.toLowerCase() || "down" === c.toLowerCase())
                                e = ".y-scroll", d = ".swipe-y";
                            d = b.el.closest(d);
                            e = b.el.closest(e);
                            ...
                            "last"in b && (b.el.trigger("tap"), f = setTimeout(function() {
                                f = null;
    ...
    a.afui.animateHeader = function(g) {
        a.afui.setTitle = !1 !== g ? function(b, f, e, c) {
            ...
            d && 0 !== d.length && (b = a(this.activeDiv).closest(".view").children("header").eq(0), e = e ? "header-unload" : "header-load", f = b.find("h1").eq(0).html(), b.find("h1").eq(0).html(d).removeClass("header-unload header-load"), c || (b.find("h1").animation().run(e + "-to"), c = a("<h1>" + f + "</h1>"),
                    b.append(c), c.animation().end(function() {
                a(this).remove()
            }).run(e)))
        } : h
    }
...
(function(a) {
    ...
    var h = [], g = function(b, e) {
        if (this.container = "string" === typeof b || b instanceof String ? document.getElementById(b) : b)
            ...
            window.alert("Error finding container for popup " + b)
    };
    g.prototype =
            {id: null, addCssClass: null, title: null, message: null, cancelText: null, cancelCallback: null, cancelClass: null, doneText: null, doneCallback: null, doneClass: null, cancelOnly: !1, onShow: null, autoCloseDone: !0, suppressTitle: !1, show: function() {
                    var b = this, e = a("<div id='" + this.id + "' class='afPopup hidden " + this.addCssClass + "'><header>" + this.title + "</header><div>" + this.message + "</div><footer><a href='javascript:;' class='" + this.cancelClass + "' id='cancel'>" + this.cancelText + "</a><a href='javascript:;' class='" + this.doneClass +
                    ...
                    a.unblockUI();
                    !a.os.ie && !a.os.android ? setTimeout(function() {
                        b.remove()
                    }, 250) : b.remove()
                }, remove: function() {
    ...
    a.blockUI = function(f) {
        b || (f = f ? " style='opacity:" + f + ";'" : "", a.query("BODY").prepend(a("<div id='mask'" + f + "></div>")), a.query("BODY DIV#mask").bind("touchstart", function(a) {
            a.preventDefault()
        }), a.query("BODY DIV#mask").bind("touchmove", function(a) {
            a.preventDefault()
        }), b = !0)
    };
    ...
    a.afui.registerDataDirective("[data-alert]", function(b) {
...
(function(a) {
    ...
    h.prototype = {element: null, animClass: null, runEnd: !1, keepClass: !1, keep: function() {
            this.keepClass = !0;
            return this
        }, remove: function(a) {
            ...
            return this
        }, endCBCache: null, run: function(a, c) {
            this.runEnd = !1;
            ...
            this.animClass = a;
            var d = window.getComputedStyle(this.element, null), f = d.animation - c;
    ...
    g.prototype = {element: null, runEnd: !1, keepEnd: !1, keep: function() {
            this.keepEnd = !0;
            return this
        }, endCBCache: null, timer: null, run: function(b, c) {
...
(function(a) {
    ...
    var g = null, b, f = {push: function(b, c, d) {
    ...
    h.prototype = {defaultTransition: "slide", defaultAnimation: "cover", isTransitioning: !1, autoHide: function(a) {
            a.preventDefault();
            this.hide()
        ...
        autoHideCheck: null, selfCheckViewToClose: null, show: function(e, c, d) {
            if (!this.isTransitioning) {
                ...
                l && (b = l, l.classList.contains("active") || (this.isTransitioning = !0, this.autoHideCheck = this.autoHide.bind(this), a(l).closest(".view").children().filter(":not(nav):not(aside)").off("touchstart", this.autoHideCheck), l.classList.add(g), e = a(l).show(), c = "right" === g ? "left" : "right", 0 < a(l).closest(".view").find(".slide-" +
                        c + "-out").length && (a(l).closest(".view").find(".slide-" + c + "-out").removeClass("slide-" + c + "-out"), a(l).closest(".view").find("aside.active, nav.active").removeClass("left right active").hide()), "reveal" !== d ? e.css("zIndex", "999").animation().run("slide-" + g + "-in").end(function() {
                    ...
                    this.classList.add("active");
                    h.isTransitioning = !1
                }), l.activeAnimation = d, l.activePosition = g, l.toggled = !0,
                        f[d](l, !1), setTimeout(function() {
            ...
            if (!this.isTransitioning) {
                ...
                if (g && g.toggled) {
                    ...
                    if (f[g.activeAnimation])
                        f[g.activeAnimation](g, !0);
                    g.toggled = !1;
                    b = null
                }
            }
    ...
    a.afui.registerDataDirective("[data-left-menu]:not([data-menu-close]),[data-right-menu]:not([data-menu-close])",
            function(b) {
                ...
                var d = "left" === b ? c.attr("data-left-menu") : c.attr("data-right-menu"), c = c.attr("data-transition");
    ...
    a.afui.registerDataDirective("[data-menu-close]", function(b) {
        ...
        if (!c && (c = a(b).closest("nav").prop("id"), !c || 0 === c.length))
            c = a(b).closest(".view").find("nav.active,aside.active").prop("id");
...
(function(a) {
    ...
    a(document).on("swipeStartLeft", ".swipe-reveal", function(c, d, m) {
        m.preventDefault();
        h = a(c.target).closest(".swipe-content");
        g = d.x2;
        f = h.closest(".swipe-reveal").find(".swipe-hidden").width();
        0 === a.getCssMatrix(c.target).e && (h.bind("touchmove", e), h.one("touchend", function() {
    ...
    a(document).on("swipeStartRight",
            ".swipe-reveal", function(c, d, m) {
                m.preventDefault();
                h = a(c.target).closest(".swipe-content");
                f = h.closest(".swipe-reveal").find(".swipe-hidden").width();
                0 === a(c.target).parents(".swipe-content").length && 0 === a.getCssMatrix(c.target).e || (g = d.x2 + f, h.bind("touchmove", e), h.one("touchend", function() {
                    h.unbind("touchmove", e);
...
(function(a) {
    ...
    if (!a.os.supportsTouch) {
        ...
        var b = function(a) {
            a.preventDefault();
            a.stopPropagation()
        }, f = navigator.userAgent.match(/Phone/i) ? 2 : 7, e = function(a, c) {
            var d = c.tagName.toUpperCase();
            -1 < d.indexOf("SELECT") || (-1 < d.indexOf("OPTION") || -1 < d.indexOf("TEXTAREA") || -1 < d.indexOf("INPUT")) || b(a)
        }, c = function(b, c, d, f) {
            d = d ? d : c.target;
            f || e(c, d);
            ...
            f.mouseToTouch = !0;
            if (a.os.ie)
                for (c = c.target; null !== c; )
                    c.hasAttribute("on" + b) && eval(c.getAttribute("on" +
                            b)), c = c.parentElement;
            d.dispatchEvent(f)
        }, d = !1, m = null, l = 0, p = 0;
        window.navigator.msPointerEnabled ? (document.addEventListener("MSPointerDown", function(a) {
            d = !0;
            m = a.target;
            ...
            p = a.clientY;
            return!0
        }, !0), document.addEventListener("MSPointerUp", function(a) {
            if (d)
                return c("touchend", a, m, !0), m = null, d = !1, !0
        }, !0), document.addEventListener("MSPointerMove", function(a) {
            if (!(Math.abs(a.clientX -
                    l) <= f || Math.abs(a.clientY - p) <= f) && d)
                return c("touchmove", a, m, !0), h = !0
            ...
            l = a.clientX;
            p = a.clientY
        }, !0), document.addEventListener("mouseup", function(a) {
            d && (c("touchend", a, m), m = null, d = !1)
        }, !0), document.addEventListener("mousemove", function(a) {
            !(a.clientX === l && a.clientY === p) && d && (c("touchmove", a, m), h = !0)
        },
                !0));
...
(function(a) {
    ...
    var h = function() {
        var g = function(b, f) {
            if (this.container = "string" === typeof b || b instanceof String ? document.getElementById(b) : b) {
                ...
                window.alert("Error finding container for toast " + b)
        };
        g.prototype = {addCssClass: null, message: null, delay: 5E3, el: null, container: null, timer: null, autoClose: !0, show: function() {
                var b = this;
                this.el = a("<div  class='afToast " + this.type + "'><div>" + this.message + "</div></div>").get(0);
                this.container.append(this.el);
                var f = a(this.el), e = this.el.clientHeight;
                f.addClass("hidden");
                setTimeout(function() {
                    f.css("height", e);
    ...
    a.afui.registerDataDirective("[data-toast]", function(g) {
        ...
        if (0 !== g.length) {
            var f = b.attr("data-position") || "tr", e = b.attr("data-type"), c = "false" === b.attr("data-auto-close") ? !1 : !0, b = b.attr("data-delay") || 0;
...
(function(a) {
    ...
    h.prototype = {logo: "<div class='icon database big'></div>", roundKeyboard: !1, validatePassword: function() {
        }, renderKeyboard: function() {
            for (var a = "", b = 0; 8 > b; b += 3) {
                for (var a = a + "<div class='row'>", f = 1; 3 >= f; f++)
                    var e = b + f, a = a + ("<div data-key='" + e + "'>" + e + "</div>");
                a += "</div>"
            }
        ...
        show: function() {
            if (!this.visible) {
                var g = "<div class='content flexContainer'><div class='password'>" + this.logo + "<input maxlength=4 type='password' placeholder='****' disabled></div><div class='error'>Invalid Password</div></div>", g = g + ("<div class='keyboard flexContainer'>" + this.renderKeyboard() + "</div>"), b = a("<div id='lockScreen'/>");
                b.html(g);
                this.roundKeyboard && (b.addClass("round"), b.find("input[type='password']").attr("placeholder", "\u25cc\u25cc\u25cc\u25cc"));
                this.lockscreen = b;
                a(document.body).append(b);
                var f = a("#lockScreen input[type='password']"), e = this;
                a(b).on("click", function(b) {
                    b = a(b.target);
                    if (0 !== b.length && (b = b.attr("data-key")))
                        "delete" === b ? f.val(f.val().substring(0, f.val().length - 1)) : (4 > f.val().length && f.val(f.val() + b), 4 === f.val().length && (e.validatePassword(f.val()) ? e.hide() : (e.lockscreen.find(".error").css("visibility", "visible"), setTimeout(function() {
                            e.lockscreen.find(".error").css("visibility", "hidden");
                            f.val("")
                        }, 1E3))))
                });
                a(b).on("touchstart", function(b) {
